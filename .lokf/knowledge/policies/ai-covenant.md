...
title: AI covenant
description: Community norms for AI use - contributors own what they submit regardless of tooling, AI must not post autonomously in discussions, and AI co-authorship in commit messages is discouraged.
genre: reference
